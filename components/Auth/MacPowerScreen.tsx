...
interface MacPowerScreenProps {
  goNext: () => void;
  autoBoot?: boolean;
}

export default function MacPowerScreen({ goNext, autoBoot = false }: MacPowerScreenProps) {
  ...
  return (
    <div 
      className="w-screen h-screen flex flex-col items-center justify-center overflow-hidden bg-cover bg-center relative"
