...
export default function ClockWidget() {
  ...
  for (let i = 0; i < 60; i++) {
    ...
    const strokeColor = isActive ? 'rgba(255, 255, 255, 0.9)' : 'rgba(255, 255, 255, 0.15)';
  ...
  return (
    <div className="w-40 h-40 rounded-[32px] flex flex-col items-center justify-center select-none shrink-0 pointer-events-auto relative overflow-hidden transition-all duration-300 shadow-lg bg-gradient-to-br from-[#1c1c1e] to-[#2c2c2e] text-white border border-white/5">
