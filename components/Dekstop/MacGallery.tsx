...
// Map to old icon names for compatibility
const FiChevronLeft = ChevronLeft
const FiChevronRight = ChevronRight
const FiX = X
const FiDownload = Download
const FiSearch = Search
const FiMoreHorizontal = MoreHorizontal
const FiInfo = Info
const FiShare = Share
...
const FiVideo = Video
const FiCamera = Camera
const FiUser = User
const FiTrash2 = Trash2
const FiLock = Lock
const FiPlus = Plus
const FiMinus = Minus
const FiSliders = Sliders
const FiList = List

const BsImage = ImageIcon
const BsHeart = Heart
const BsHeartFill = Heart
const BsDownload = Download
const BsGrid3X3 = Grid3X3
const BsLock = Lock
const BsDisplay = Monitor
const BsGrid = Grid
...
import wallpaper2 from '/public/Wallpaper/wallpaper-2.jpg'
import wallpaper3 from '/public/Wallpaper/wallpaper-3.jpg'
import wallpaper4 from '/public/Wallpaper/wallpaper-4.jpg'
import wallpaper5 from '/public/Wallpaper/wallpaper-5.jpg'
import wallpaper6 from '/public/Wallpaper/wallpaper-6.jpg'
import wallpaper7 from '/public/Wallpaper/wallpaper-7.jpg'
import wallpaper8 from '/public/Wallpaper/wallpaper-8.jpg'
import wallpaper9 from '/public/Wallpaper/wallpaper-9.jpg'
import wallpaper10 from '/public/Wallpaper/wallpaper-10.jpg'
...
const IMAGES = [
  ...
  '/Wallpaper/wallpaper-7.jpg',
  '/Wallpaper/wallpaper-8.jpg',
  '/Wallpaper/wallpaper-9.jpg',
  '/Wallpaper/wallpaper-10.jpg',
];
...
// Traffic lights inside the Photos sidebar (decorative only)
