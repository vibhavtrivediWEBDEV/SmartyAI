...
interface WidgetCreationModalProps {
  ...
  onCreateSnapshot: (url: string, title: string) => void;
  isDarkMode: boolean;
}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <div className={`text-xs mt-1 ${mutedText}`}>
                      Static screenshot of current view. Works with all websites including YouTube, social media.
                    </div>
                    {selectedType === 'snapshot' && (
                      <div className={`text-xs mt-2 text-purple-400`}>
                        ✓ Works everywhere • No embedding issues
                      </div>
                    )}
                  </div>
                </div>
