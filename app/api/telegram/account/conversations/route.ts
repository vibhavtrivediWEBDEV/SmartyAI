...
import { getTelegramAccount, listTelegramConversations } from '@/lib/telegram/accountRepository'
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ conversations: await listTelegramConversations(userId) })
  } catch (error) {
